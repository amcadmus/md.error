...
recoverDeviceData (MDTimer * timer)
{
  ...
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
      (ddata.fcx, ddata.numAtom, backMapTable, recoveredDdata.fcx);
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
      (ddata.fcy, ddata.numAtom, backMapTable, recoveredDdata.fcy);
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
      (ddata.fcz, ddata.numAtom, backMapTable, recoveredDdata.fcz);
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
	   ...
	   MDTimer * timer)
{
  ...
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
      (bkDdata.fcx, ddata.numAtom, indexTable, ddata.fcx);
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
      (bkDdata.fcy, ddata.numAtom, indexTable, ddata.fcy);
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
      (bkDdata.fcz, ddata.numAtom, indexTable, ddata.fcz);
  Reshuffle_reshuffleArray
      <<<atomGridDim, myBlockDim>>>
