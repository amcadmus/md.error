...
pl\
't0.85-n16000-adapt-e0.0045-extend/a.rcut.x.out' every 1 axes x2y2 w l ls 1 t 'r_c',\
't0.85-n16000-adapt-e0.0045-extend/a.real.x.out'  every 1 axes x1y1 w p ls 3 t '{/Symbol e}_{real}',\
't0.85-n16000-adapt-e0.0045-extend/a.error.x.out' every 1 axes x1y1 w l ls 2 t '{/Symbol e}_{esti}',\
...
set y2label 'Cut-off radius  r_c*'
