...
unset title
unset label
set label 'T*=1.20, liquid' at 5.5,0.59
set clip two
set style fill pattern 8

pl \
't1.20.liquid.ref.out' u 1:($2+$3):($2-$3) w filledcu lc 0 not,\
't1.20.liquid.ref.out' u 1:2 w l lt 1 lc 0 lw 3 not,\
't1.20.liquid.uni.out'   u 1:($2):3 w e ls 11 not, '' u 1:($2) w l ls 11 t'URC',\
't1.20.liquid.adapt.out' u 1:($2):3 w e ls 21 not, '' u 1:($2) w l ls 21 t'ARC',\
't1.20.liquid.fcorr.out' u 1:($2):3 w e ls 31 not, '' u 1:($2) w l ls 31 t'LFC'
