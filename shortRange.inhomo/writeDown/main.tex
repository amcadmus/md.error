...
implies that the calculation  requires more compuational resources
...
critical region where the corrlation plays an important role in the system,
the corrlation error should be taken into account.
...
National Natural Science Foundation of China (20490222).
