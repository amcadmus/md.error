...
The wedge notation $\wedge$ means Fourier transform. The prime on $\v k_{k_1,k_2,k_3}$ means
...
\redc{ The precise calculation of the correction force needs the
...
dominated the simulation with uniform cut-off, we conclude the homogeneity
