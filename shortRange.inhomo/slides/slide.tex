...
\begin{frame}{Error of fast algorithms}
  ...
  \item<2-> How cut-off method works. Cost \redc{$\mathcal O(r_c^3)$}.
  \item<3-> Mostly used $r_c$: 2.5 -- 4.0 $\sigma$. \redc{Convergence check} required.
  \item<4-> Qualitatively: \redc{error estimate}.
  \end{itemize}
\end{frame}
