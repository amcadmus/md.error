...
do
    ...
    echo "# #############################################################################" &>> $mylog
    ./tools/real.error/ewaldSum --config $record_dir/$i --charge-table $record_dir/charge.tab --beta $beta --rcut $ref_rcut --kx $ref_Kx --ky $ref_Ky --kz $ref_Kz --output-force force.ref.$iname.out &>> $mylog
