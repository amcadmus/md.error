...
do
	...
	./tools/real.error/spme --config $record_dir/$i --method fbspline --beta $beta --rcut $cal_rcut --kx $cal_Kx --ky $cal_Ky --kz $cal_Kz --order $cal_order --output-force force.spme.ana.out &>> $mylog
