...
set style line 61 lc 5 lw 3 pt 1 lt 0
...
'real.spme.ana.noHO.st.error.out'	u 1:2 w p ls 14 t 'noHO st real E',\
'real.spme.ana.noHO.st.error.out'	u 1:3 w p ls 24 t 'noHO st real E',\
'real.spme.ana.noHO.st.error.out'	u 1:4 w p ls 34 t 'noHO st real E',\
'esti.spme.ana.error.out'		u 1:4 w l ls 61 t 'estimated E_{rec}',\
