...
pl\
'rand2/real.ewald.error.out' u 1:(138.935485*$4) w p ls 21 not 'real Ewald rec',\
'rand2/esti.ewald.error.out' u 1:(138.935485*$4) w l ls 21 not 'estimated Ewald rec'
...
set label "st ik,ana" at 7.5,0.7e-2
...
pl\
'rand2/real.spme.ana.st.error.out'	u 1:(138.935485*$3) w p ls 11 not 'real dir',\
'rand2/real.spme.ik.st.error.out'	u 1:(138.935485*$4) w p ls 33 not 'real rec ik st', \
'rand2/real.spme.ana.selfCorr.error.out'u 1:(138.935485*$4) w p ls 32 not 'real rec ana sc', \
'rand2/real.spme.ana.st.error.out'	u 1:(138.935485*$4) w p ls 31 not 'real rec ana st', \
'rand2/esti.spme.st.error.out'		u 1:(138.935485*$3) w l ls 11 not 'esti dir',\
'rand2/esti.spme.st.error.out'		u 1:(138.935485*$4) w l ls 31 not 'esti rec st', \
'rand2/esti.spme.ana.selfCorr.error.out'u 1:(138.935485*$4) w l ls 32 not 'esti rec ana sc'

# 'rand2/real.spme.ik.error.out'		u 1:(138.935485*$4) w p ls 34 not 'real rec ik', \
# 'rand2/esti.spme.ik.error.out'		u 1:(138.935485*$4) w l ls 34 not 'esti ik', \
