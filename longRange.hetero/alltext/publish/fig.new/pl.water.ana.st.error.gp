...
set out 'fig.water.ana.st.error.eps'
...
set style line 34 lc 3 lw 3 pt 7 lt 4
...
# 'water/real.spme.ana.noHO.st.error.out'	u 1:(138.935485*$3) w p ls 11 not 'real dir',\
# 'water/esti.spme.st.h2o.error.out'	u 1:(138.935485*$3) w l ls 11 not 'esti dir',\


#'tmp.out'				u 1:(138.935485*$4) w p ls 21 not 'esti rec ana sc',\


# 'water/esti.spme.ik.error.out'	u 1:(138.935485*$4) w l ls 21 not 'esti rec ana sc',\
# 'water/real.spme.ik.error.out'	u 1:(138.935485*$4) w p ls 21 not 'real rec ana sc', \
# 'water/esti.spme.ana.selfCorr.error.out'u 1:(138.935485*$4) w l ls 21 not 'esti rec ana sc',\
# 'water/real.spme.ana.noHO.error.out'	u 1:(138.935485*$4) w p ls 21 not 'real rec ana sc', \
