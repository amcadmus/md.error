...
'real.spme.ana.st.meanf.out'		u 1:(138.935485*$5) w p ls 11 not 'real dir',\
'real.spme.ana.st.meanf.out'		u 1:(138.935485*$8) w p ls 31 not 'real rec ana st', \
'real.spme.ana.selfCorr.meanf.out'	u 1:(138.935485*$8) w p ls 32 not 'real rec ana sc', \
'esti.spme.st.meanf.out'		u 1:(138.935485*$5) w l ls 11 not 'esti dir',\
'esti.spme.st.meanf.out'		u 1:(138.935485*$8) w l ls 31 not 'esti rec st', \
'esti.spme.ana.selfCorr.meanf.out'	u 1:(138.935485*$8) w l ls 32 not 'esti rec ana sc'
